...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Offices", path: "/people/offices", icon: Building, module: "departments" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Subscription", path: "/subscription", icon: CreditCard, module: "subscription" },
  ...
  {
    // Rendered only for `is_platform_admin` users — see `canAccessPlatformAdmin`.
    // Not role-gated: an org's own super_admin ("Owner") never sees this group.
    label: "Platform",
    items: [{ label: "Organizations", path: "/platform/organizations", icon: Building, module: "platform" }],
  },
];
