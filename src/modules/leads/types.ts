...
// Default gap before a quick-logged, not-yet-resolved follow-up resurfaces as due —
// shorter for hotter leads so the list naturally re-flags them sooner.
export const NEXT_FOLLOW_UP_GAP_DAYS: Record<LeadPriority, number> = {
  hot: 1,
  warm: 3,
  cold: 5,
};
