...
import { KeyRound, LogIn, MoreHorizontal, Plus, RotateCcw, ShieldCheck, Trash2, UserCog } from "lucide-react";
...
export function UsersPage() {
  ...
  const columns = useMemo<ColumnDef<UserRead, any>[]>(
        ...
        cell: ({ row }) => (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
              ...
              {actingRole === UserRole.SUPER_ADMIN && row.original.id !== currentUserId && row.original.role !== UserRole.SUPER_ADMIN && (
                <DropdownMenuItem onSelect={() => impersonate.mutate(row.original.id)}>
    ...
    [deleteUser, restoreUser, impersonate, actingRole, currentUserId],
  );
