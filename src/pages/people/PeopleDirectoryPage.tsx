    ...
    >
      ...
      <div className="min-w-0 w-full">
        ...
        <p className="mt-1.5 truncate text-[11px] text-muted-foreground/80">
          ...
          {employee.office_name && <> · {employee.office_name}</>}
...
export function PeopleDirectoryPage() {
  ...
  return (
    <div>
      <PageHeader title="Directory" description="Every staff account in your organization, with department and employment details." />
