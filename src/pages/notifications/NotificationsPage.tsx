          ...
          data.items.map((n) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "flex items-start gap-3 border-b border-border p-4 transition-colors last:border-none hover:bg-muted/30",
              ...
              >
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    n.is_read ? markUnread.mutate(n.id) : markRead.mutate(n.id);
                  }}
                >
                  {n.is_read ? (
                    <>
