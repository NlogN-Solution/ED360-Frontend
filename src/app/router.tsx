...
import { GoogleOAuthCallbackPage } from "@/pages/oauth/GoogleOAuthCallbackPage";
...
const CountryDetailPage = lazy(() => import("@/pages/academic/CountryDetailPage").then((m) => ({ default: m.CountryDetailPage })));
const UniversityDetailPage = lazy(() =>
  import("@/pages/academic/UniversityDetailPage").then((m) => ({ default: m.UniversityDetailPage })),
);
...
const OfficesPage = lazy(() => import("@/pages/people/OfficesPage").then((m) => ({ default: m.OfficesPage })));
...
const PlatformOrganizationsPage = lazy(() =>
  import("@/pages/platform/PlatformOrganizationsPage").then((m) => ({ default: m.PlatformOrganizationsPage })),
);
const PlatformOrganizationDetailPage = lazy(() =>
  import("@/pages/platform/PlatformOrganizationDetailPage").then((m) => ({ default: m.PlatformOrganizationDetailPage })),
);
...
function withPlatformAdmin(element: ReactNode) {
  return (
...
export const router = createBrowserRouter([
  ...
  // Standalone popup target — no AuthLayout/AppShell chrome, no auth guard.
  // See modules/email/googleOAuth.ts for what opens it.
  { path: "/oauth/google/callback", element: <GoogleOAuthCallbackPage /> },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "/academic/countries/:countryId", element: withModule("academic", <CountryDetailPage />) },
          { path: "/academic/universities/:universityId", element: withModule("academic", <UniversityDetailPage />) },
          { path: "/academic/programs/:programId", element: withModule("academic", <ProgramDetailPage />) },
          ...
          { path: "/people/offices", element: withModule("departments", <OfficesPage />) },
          ...
          { path: "/subscription", element: withModule("subscription", <SubscriptionPage />) },
